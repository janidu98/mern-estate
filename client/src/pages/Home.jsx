    ...
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          Janidu Estate is the best place to find your next perfect place to live.
          <br/>
      ...
      <div className="max-w-6xl w-full mx-auto p-3 flex flex-col gap-8 my-10">
          {
            offerListings && offerListings.length > 0 && (
              <div className="">
                <div className="my-3">
                  <h1 className='text-2xl text-slate-600 font-semibold'>Recent offers</h1>
          ...
          }
          {
            rentListings && rentListings.length > 0 && (
              <div className="">
                <div className="my-3">
                  <h1 className='text-2xl text-slate-600 font-semibold'>Recent places for rent</h1>
          ...
          }
          {
            saleListings && saleListings.length > 0 && (
              <div className="">
                <div className="my-3">
                  <h1 className='text-2xl text-slate-600 font-semibold'>Recent places for sale</h1>

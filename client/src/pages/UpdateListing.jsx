...
const UpdateListing = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      const res = await fetch(`/api/listing/update/${params.listingId}`, config);
      const data = await res.json();
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            ...
            <button 
              type='button'
              disabled={uploading}
              className='uppercase p-3 text-green-700 border border-green-700 hover:shadow-lg disabled:opacity-80'

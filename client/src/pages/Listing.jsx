    ...
    <main>
      ...
      {error && 
        <p className='text-center text-2xl my-7 text-red-700'>
            ...
            <Link to={'/'}><p className='text-sm mt-5 text-blue-700 hover:underline'>Go to Home</p></Link>
        </p>
      }
        ...
        <>
            ...
            <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                ...
                {currentUser && listing.userRef !== currentUser._id && !contact && (
                    <button onClick={() => setContact(true)} className='bg-slate-700 rounded-lg p-3 mt-4 text-white hover:opacity-95'>Contact Us</button>
                )} 
